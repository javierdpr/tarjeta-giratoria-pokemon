//tendo que ordenar los pokemon por el numero
const pokemonContainer = document.querySelector('.pokemon-container');
//https://pokeapi.co/api/v2/pokedex/{id o nombre}/
//definimos las variables offset y limit para obtener 9 pokemon
let offset = 1;
let limit = 8;
//declaramos las variables de los botones de la paginas 
const previous = document.querySelector("#previous");
const next = document.querySelector("#next")
//creamos el evento click de previous para colver atras
...
//creamos el evento para avanzar
...
//aki llamamos a la api
function fetchPokemon(id){
    fetch('https://pokeapi.co/api/v2/pokemon/'+id+'/')
    .then(res => res.json())
    .then(data => {
        //con esto consigo la lista de los 9 primeros 
        //console.log(data.name);
        //document.getElementById("salida").innerHTML += "<br>"+data.name;
        createPokemon(data);
...
//esto es para la barra de estadisticas
...
fetchPokemons(offset, limit);
//para el buscador tendria que declarar una variable con los nombres de los pokemon

//quiero hacer un bsucador 
